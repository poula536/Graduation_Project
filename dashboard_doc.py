...
label_doc=Label(doctor_window,text="مرحبا دكتوراسامه شفيق",fg="#331c48",bg="#ECF9FF",font=('Microsoft YaHei UI Light ',30))
...
bfw_btn = tkinter.PhotoImage(file='backfw.png',master=doctor_window)
